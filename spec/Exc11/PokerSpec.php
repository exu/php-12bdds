 ...
 * data).
 *
 * Each card also has a value which is one of 2, 3, 4, 5, 6, 7, 8, 9, 10,
 ...
 *
 * Your job is to rank pairs of poker hands and to indicate which, if either,
 * has a higher rank.
 *
 * Examples:
 ...
 * Output: Tie
 */
class PokerSpec extends ObjectBehavior
{
    function it_is_initializable()
    {
        /* $this->shouldHaveType('Exc11\Poker'); */
    }
}
