 ...
 * the score for that frame is simply the total number of pins knocked down in
 * those two balls.
 *
 * If you get a spare in the last (10th) frame you get one more bonus ball. If
 * you get a strike in the last (10th) frame you get two more bonus balls.
 *
 * These bonus throws are taken as part of the same turn. If a bonus ball
 * knocks down all the pins, the process does not repeat. The bonus balls are
...
class BowlingSpec extends ObjectBehavior
{
    ...
    {
        /* $this->shouldHaveType('Exc09\Bowling'); */
    }
}
